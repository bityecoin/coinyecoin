...
static const int64 MAX_MONEY = 23333333333 * COIN; // CoinyeCoin: maximum of 133.3 billion COYE
...
static const uint256 hashGenesisBlockOfficial("0x333393f85bb4efb996d537a5ccbf563534e6dbc1b273ba4a8264bf99b89bca3f");
...
void UpdateCoins(const CTransaction& tx, CValidationState &state, CCoinsViewCache &inputs, CTxUndo &txundo, int nHeight, const uint256 &txhash);
    ...
    {
        std::string str;
        str += strprintf("CTransaction(hash=%s, ver=%d, vin.size=%" PRIszu ", vout.size=%" PRIszu ", nLockTime=%d)\n",
