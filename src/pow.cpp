...
bool AllowMinDifficultyForBlock(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    // Coinyecoin: Magic number at which reset protocol switches
...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    // Coinyecoin: Special rules for minimum difficulty blocks with Digishield
    ...
    bool fNewDifficultyProtocol = (pindexLast->nHeight >= 4000000);
    ...
    return CalculateCoinyecoinNextWorkRequired(pindexLast, pindexFirst->GetBlockTime(), params);
}
