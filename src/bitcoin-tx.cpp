...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s coinyecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  coinyecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded coinyecoin transaction") + "\n" +
              "  coinyecoin-tx [options] -create [commands]   " + _("Create hex-encoded coinyecoin transaction") + "\n" +
              "\n";
