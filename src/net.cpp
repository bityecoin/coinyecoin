...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "coinyecoin " + FormatFullVersion();
...
//#endif
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. coinyecoin is probably already running."), addrBind.ToString().c_str());
        else
