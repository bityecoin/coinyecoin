...
void SendCoinsDialog::updateGlobalFeeVariables()
{
    if (ui->radioSmartFee->isChecked())
    {
        ...
        // Coinyecoin: We manually set height well past the last hard fork here
...
void SendCoinsDialog::updateSmartFeeLabel()
{
    ...
    if (feeRate <= CFeeRate(0)) // not enough data => minfee
    {
        ...
        ui->fallbackFeeWarningLabel->setIndent(QFontMetrics(ui->fallbackFeeWarningLabel->font()).horizontalAdvance(QStringLiteral("x")));
    }
    else
    {
        ui->labelSmartFee->setText(BitcoinUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(),
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid Coinyecoin address"));
        }
        else // Valid address
        {
            CKeyID keyid;
