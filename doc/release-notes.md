Coinyecoin Core version 1.14.2 is now available from:

  <https://github.com/coinyecoin/coinyecoin/releases/tag/v1.14.0/>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/coinyecoin/coinyecoin/issues>

To receive security and update notifications, please watch reddit or Twitter:

  * https://www.reddit.com/r/coinyecoin/
  * @Coinyecoin on Twitter for high priority announcements
  * @coinyecoin\_devs on Twitter for updates on development work
...
Coinyecoin Core is extensively tested on Ubuntu Server LTS, Mac OS X and Windows 10.
...
Coinyecoin Core should also work on most other Unix-like systems but is not
...
Coinyecoin Core introduces pruning the blockchain in 1.14. Pruning
...
When Coinyecoin Core is out-of-sync on startup, a semi-transparent information
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of Coinyecoin Core. This was added in conjunction with
