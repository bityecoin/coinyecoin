TEMPLATE = app
TARGET = coinyecoin-qt
macx:TARGET = "Coinyecoin-Qt"
VERSION = 1.6.0
INCLUDEPATH += src src/json src/qt
QT += core gui network
greaterThan(QT_MAJOR_VERSION, 4): QT += widgets
DEFINES += QT_GUI BOOST_THREAD_USE_LIB BOOST_SPIRIT_THREADSAFE QT_DISABLE_DEPRECATED_BEFORE=0x000000 BOOST_THREAD_PROVIDES_GENERIC_SHARED_MUTEX_ON_WIN __NO_SYSTEM_INCLUDES
...
macx: {
    ...
    DEFINES += MAC_OSX
    ICON = src/mac/artwork/Coinyecoin.icns
...
QMAKE_CXXFLAGS_WARN_ON = -fdiagnostics-show-option -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector -O
